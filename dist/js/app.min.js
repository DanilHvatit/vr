...
$(document).ready(function () {
    ...
    $.getJSON("vr.json", function (data) {
        vr = data;
        let items = [];
        generateGameCarts(data,items);
        $('.games__content-vr').append(items);
    });
    ...
    $.getJSON("board.json", function (data) {
        ...
        let items = [];
        generateGameCarts(data, items);
        $('.games__content-board').append(items);
    });
    
    function generateGameCarts(data, items) {
        $.each(data, function (ind) {
            items.push(`<div class="games__item" data-games="` + ind +`">
                        <div class="games__wrapper">
                        <div class="games__img" style="background-image: url(images/dest/games/vr/`+ data[ind].name.replace(/ /g, '-').toLowerCase() + `.png)">
                            <img src="images/dest/games/default.png" alt="" />
                        </div>
                        <div class="games__description">
                            <div class="games__name">`+ data[ind].name + `</div>
                            <div class="games__genre">`+ data[ind].genre + `</div>
                            <div class="games__info">Кол-во игроков: <span>`+ data[ind].count + `</span> </div>
                            <div class="games__info">Возраст: <span>`+ data[ind].age + `</span> </div>
    ...
    $('body').on("click", '.games__btn', function () {
        ...
        let info = `<div class="games__name">`+ vr[ind].name + `</div>
                            <div class="games__genre">`+ vr[ind].genre + `</div>
                            <div class="games__info">Кол-во игроков: <span>`+ vr[ind].count + `</span> </div>
                            <div class="games__info">Возраст: <span>`+ vr[ind].age + `</span> </div>
                            <div class="popup-game__text text-overflow">`+ vr[ind].text + `</div>
                            <div class="popup-game__btn">ЧИТАТЬ ДАЛЕЕ</div>
                        `;
        $('.popup-game__info').html(info);
        $('.popup-game__img').html(`<img src="images/dest/games/vr/` + vr[ind].name.replace(/ /g, '-').toLowerCase() + `.png" alt="" />`);
        $('.popup-game').addClass('popup-game-active');
        $('body').addClass('popup-show');
        let more = '+ ' + $('.gallery__item').length + ' фото';
