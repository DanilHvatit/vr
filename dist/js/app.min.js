...
$(document).ready(function () {
    ...
    $.getJSON("board.json", function (data) {
        board = data;
        let items = [];
        generateGameCarts(board, items, 'board');
        $('.games__content-board .container').append(items);
    });
    
    function generateGameCarts(datax, items, path) {
    ...
    $('body').on("click", '.games__show', function () {
        ...
        $('.games__content .gallery-popup__close').off().on("click", function () {
