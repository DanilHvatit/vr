...
$(document).ready(function () {
    ...
    $('body').on("click", '.games__show', function () {
        ...
        $('.games__close').on("click", function () {
            ...
            $('html').scrollTop($(this).closest('.games__content').find('.games__show').offset().top)
        })
    })
    ...
    $('body').on("click", '.games__btn', function () {
        ...
        if ($('.popup-game__text').css('height').slice(0, 3) == $('.popup-game__text').css('line-height').slice(0, 2) * $('.popup-game__text').css('line-clamp')) {
            $('.popup-game__text').append('<div class="popup-game__btn">ЧИТАТЬ ДАЛЕЕ</div>');
        }
        ...
        $('.gallery__item:first').css({ 'flex-basis': +$('.popup-game__img img').css('width').slice(0, 3) + 10 +'px' });
    ...
    $('body').on("click", '.popup-game__btn', function () {
        ...
        $('.gallery').toggleClass('gallery-showText');
    ...
    function filterList(value) {
        let list = $(".games__content-show .games__item");
        $(list).hide();
        if (value == "All") {
            $(".games__content-show").find(".games__item").each(function (i) {
                $(this).show();
    ...
    $(".contacts__form").on("submit", function (event) {
        ...
        let fd = new FormData(document.querySelector(formClass));
        $.ajax({
            url: "./php/send.php",
            type: "POST",
            data: fd,
    ...
    $('body').on('click', '.header__mobile-menu', function () {
        $('.header__menu').toggleClass('header__menu-show');
        $('.header__mobile-menu').toggleClass('header__mobile-menu-show');
        $('body').toggleClass('popup-show');
     })

    $('body').on("click", '.btn-rent', function () {
        $('.rent-popup').addClass('rent-popup-show');
        $('body').addClass('popup-show');
    })
    
    $('.rent-popup__close').on("click", function () {
        $('.rent-popup').removeClass('rent-popup-show');
        $('body').removeClass('popup-show');
    })

    $('.rent-popup').on("click", function (e) {
        if (e.target == this) {
            $('.rent-popup__close').trigger('click');
        }
    });
    if ($(window).width() < 768) {
        $('.rent__item-big').appendTo($('.price-tabs__item-active .rent'))
    }
})